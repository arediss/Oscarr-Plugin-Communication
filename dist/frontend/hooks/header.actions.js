// frontend/hooks/header.actions.tsx
...
function writeReadMap(userId, map) {
  try {
    localStorage.setItem(storageKey(userId), JSON.stringify(map));
  } catch {
  }
}
function pruneReadMap(map, visibleIds) {
  const out = {};
...
function CommunicationHeaderAction({ context }) {
  const userId = context?.user?.id;
  const [open, setOpen] = useState(false);
  const [announcements, setAnnouncements] = useState([]);
  const [loading, setLoading] = useState(false);
  const [readMap, setReadMap] = useState(() => readReadMap(userId));
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx2(Megaphone, { className: "w-5 h-5 text-ndp-text-muted" }),
          unreadCount > 0 && /* @__PURE__ */ jsx2("span", { className: "absolute top-1 right-1 min-w-[1rem] h-4 px-1 rounded-full bg-ndp-accent text-[10px] font-bold text-white flex items-center justify-center", children: unreadCount > 9 ? "9+" : unreadCount })
        ]
      }
    ),
    open && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx2(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx2("div", { className: "min-h-full flex items-start justify-center px-4 py-16", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-3xl", children: [
            loading && announcements.length === 0 && /* @__PURE__ */ jsx2("div", { className: "flex items-center justify-center py-16", children: /* @__PURE__ */ jsx2("div", { className: "w-6 h-6 border-2 border-ndp-accent/30 border-t-ndp-accent rounded-full animate-spin" }) }),
            !loading && announcements.length === 0 && /* @__PURE__ */ jsxs("div", { className: "text-center py-16", children: [
              /* @__PURE__ */ jsx2(Megaphone, { className: "w-12 h-12 text-white/20 mx-auto mb-4" }),
              /* @__PURE__ */ jsx2("p", { className: "text-sm text-white/50", children: "No announcements right now." })
            ] }),
            announcements.length > 0 && /* @__PURE__ */ jsx2("div", { className: "space-y-4", children: announcements.map((a) => /* @__PURE__ */ jsx2(
              AnnouncementFrame,
              {
                announcement: a,
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              isUnread && /* @__PURE__ */ jsx2("span", { className: "absolute top-3 right-3 px-2 py-0.5 rounded-full bg-ndp-accent text-white text-[9px] font-semibold tracking-wider", children: "NEW" }),
              /* @__PURE__ */ jsx2("h3", { className: "text-xl font-bold text-white drop-shadow-md leading-snug max-w-xl mx-auto", children: announcement.title }),
              /* @__PURE__ */ jsx2("p", { className: "text-[11px] text-white/70 mt-3 tracking-wide", children: formatDateTime(announcement.publishedAt) })
            ]
          }
        ),
        /* @__PURE__ */ jsx2("div", { className: "p-8", children: /* @__PURE__ */ jsx2(MarkdownContent, { source: announcement.body }) })
      ]
    }
  );
}
export {
  CommunicationHeaderAction as default
};
